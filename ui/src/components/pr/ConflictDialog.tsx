...
// happen?" before it offers anything (AGE-172). Where the branch already is
// decides the workspace, exactly as it does for an agent review.
      ...
      >
        ...
        <div className="modal-body">
          ...
          <p className="modal-note">
            ...
            workspace: git allows a branch in one place at a time, and the merge has to land on it.
          </p>
